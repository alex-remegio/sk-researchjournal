  ...
  return (
    <section className="relative isolate overflow-hidden text-white">
      <Image
        ...
        fill
        priority
        className="scale-125 object-cover object-[center_35%] blur-md"
        sizes="100vw"
      />
      <div
        className="absolute inset-0 bg-[linear-gradient(135deg,rgba(10,42,34,0.97)_0%,rgba(15,61,50,0.94)_45%,rgba(10,26,46,0.96)_100%)]"
        aria-hidden
      />
      ...
      {/* Mobile — matches mockup: short brand + single CTA */}
