...
/** Public branding only — do not import `@/lib/env` here (pulled into client via login). */
const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || process.env.APP_NAME || "Journal Platform";
  ...
  return (
    <footer className="mt-16 border-t border-ink-200 bg-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-8 text-sm text-ink-600 md:flex-row md:justify-between">
        <p>© {new Date().getFullYear()} {APP_NAME}. Open scholarly publishing.</p>
        <p>
