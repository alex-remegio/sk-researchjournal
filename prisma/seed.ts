...
async function main() {
  ...
  const journal = await prisma.journal.create({
    data: {
      ...
      abbreviation: "JACR",
      description:
        "<p>JACR publishes original research in computing, information systems, and applied software engineering.</p>",
      issnPrint: "2049-3630",
